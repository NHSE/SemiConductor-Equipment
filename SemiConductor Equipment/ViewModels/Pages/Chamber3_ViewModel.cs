...
namespace SemiConductor_Equipment.ViewModels.Pages
{
    public partial class Chamber3_ViewModel : ObservableObject
    {
        ...
        #region CONSTRUCTOR
        public Chamber3_ViewModel(IDatabase<ChamberStatus> database, ILogManager logService, IChamberService service, IMessageBox messageBox)
        {
        ...
        private void SetupLogFileWatcher()
        {
            ...
            var logFileName = $"Chamber3_{DateTime.Now:yyyyMMdd}.log";
        ...
        {
            var logPath = Path.Combine(@"C:\Logs", $"Chamber3_{DateTime.Now:yyyyMMdd}.log");
