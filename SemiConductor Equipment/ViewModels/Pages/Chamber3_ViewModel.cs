...
namespace SemiConductor_Equipment.ViewModels.Pages
{
    public partial class Chamber3_ViewModel : ObservableObject
    {
        ...
        public Chamber3_ViewModel(ILogManager logService, IMessageBox messageBox, IChamberManager chamberManager, IEquipmentConfigManager equipmentConfigManager)
        {
            ...
            this._logManager.Subscribe($"Chamber3", OnLogUpdated);
        ...
        private void SetupLogFileWatcher()
        {
            ...
            var logFileName = $"Chamber3_{DateTime.Now:yyyyMMdd}_{DateTime.Now:HHmmss}.log";
        ...
        {
            var logPath = Path.Combine(@"C:\Logs", $"Chamber3_{DateTime.Now:yyyyMMdd}_{DateTime.Now:HHmmss}.log");
