...
{
    public partial class Chamber1_ViewModel : ObservableObject
    {
        #region FIELDS
        ...
        public Chamber1_ViewModel(IDatabase<ChamberStatus> database, ILogManager logService, IMessageBox messageBox, ChamberService service)
        {
            ...
            this._logManager.Subscribe($"Chamber1", OnLogUpdated);
        ...
        private void SetupLogFileWatcher()
        {
            ...
            var logFileName = $"Chamber1_{DateTime.Now:yyyyMMdd}.log";
        ...
        {
            var logPath = Path.Combine(@"C:\Logs", $"Chamber1_{DateTime.Now:yyyyMMdd}.log");
