...
namespace SemiConductor_Equipment.ViewModels.Pages
{
    public partial class Chamber5_ViewModel : ObservableObject
    {
        ...
        private void SetupLogFileWatcher()
        {
            ...
            var logFileName = $"Chamber5_{DateTime.Now:yyyyMMdd}_{DateTime.Now:HHmmss}.log";
        ...
        {
            var logPath = Path.Combine(@"C:\Logs", $"Chamber5_{DateTime.Now:yyyyMMdd}_{DateTime.Now:HHmmss}.log");
