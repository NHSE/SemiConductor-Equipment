...
{
    public partial class Chamber2_ViewModel : ObservableObject
    {
        #region FIELDS
        ...
        public Chamber2_ViewModel(ILogManager logService, IMessageBox messageBox, IChamberManager chamberManager, IEquipmentConfigManager equipmentConfigManager, IPLCManager plcManager)
        {
        ...
        private void OnDataEnqueued(object sender, ChamberStatus chamber)
        {
            ...
            //그 이후 각 뷰모델에서 자기 이름과 같으면 bool 반전
                if (chamber.ChamberName == "Chamber2")
                {
