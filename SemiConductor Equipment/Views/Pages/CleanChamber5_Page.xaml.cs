...
namespace SemiConductor_Equipment.Views.Pages
{
    ...
    /// </summary>
    public partial class CleanChamber5_Page : Page
    {
        #region FIELDS
        public CleanChamber5_ViewModel ViewModel { get; set; }
        #endregion
        ...
        #region CONSTRUCTOR
        public CleanChamber5_Page(CleanChamber5_ViewModel viewModel)
        {
            InitializeComponent();
            ViewModel = viewModel;
            DataContext = this;
